...
export class Node extends View {
    ...
    constructor(caption, subText) {
        ...
        this.addStyleName('blocklens-node');
...
class PropertyNode extends Node {
    ...
    constructor(name, value) {
        ...
        this.captionView.addStyleName('blocklens-property-node__property-name');
        this.valueView = new Label(value);
        this.valueView.addStyleName('blocklens-property-node__property-value');
        this.addView(this.valueView);
        this.addStyleName('blocklens-property-node');
    }
}
...
export class ChainedNode extends Node {
    ...
    constructor(caption, subText, data) {
        ...
        this.addStyleName('blocklens-node--chained');
        this.arrowLabel = new Label('<i class="material-icons">keyboard_arrow_right</i>', true);
        this.arrowLabel.addStyleName('blocklens-node__icon--right');
...
class ComponentNode extends ChainedNode {
    ...
    constructor(name, type, data) {
        ...
        if (data.faulty) {
            ...
            this.addStyleName('blocklens-node--faulty');
        }
    }
            ...
            for (let prop of properties) {
                ...
                if (properties.indexOf(prop) === 0) {
                    node.then((n) => {
                        ...
                        n.addStyleName('blocklens-node--first-of-type');
                    });
                }
            }
        } catch (e) {
...
class ContainerNode extends ComponentNode {
    ...
    async createHeader() {
        ...
        this.header.addStyleName('blocklens-node--component-container--header');
...
class WorkspaceNode extends ChainedNode {
    ...
    createHeader() {
        // Default to list view (changed from grid view per user request)
        this.isGridView = false;
        this.zoomLevel = 1;

        // Container for controls
        this.header = new HeaderNode('', 'view_list'); // Icon for list view
        this.header.addStyleName('blocklens-node--component-container--header');
        ...
        toggleBtn.innerHTML = '<i class="material-icons">view_list</i>'; // Start with list icon
    ...
    applyZoom(delta) {
        ...
        // Let's apply a style to all 'blocklens-block-node' elements?
...
class BlockNode extends Node {
    ...
    constructor(blockElement) {
        super();
        this.removeStyleName('blocklens-node'); // Remove default list style
        this.addStyleName('blocklens-block-node');
        ...
        this.previewContainer.addStyleName('blocklens-block-node__preview');
    ...
    initializeWorkspace() {
        ...
        if (this.workspace.faulty) {
            this.addStyleName('blocklens-block-node--faulty');
        }
    }
...
export class ExtensionNode extends Node {
    constructor(name, type, description) {
        super(name, type);
        this.addStyleName('blocklens-extension-node');
...
export class AssetNode extends Node {
    constructor(name, type, size, url) {
        ...
        this.addStyleName('blocklens-asset-node');
    }
    ...
    generatePreview(url, type) {
        ...
        if (this.assetSize > 15000000) {
            this.addStyleName('blocklens-asset--large-node');
...
export class SummaryNode extends Node {
    ...
    constructor(title, content) {
        super(title, '');
        this.addStyleName('blocklens-summary-node');
