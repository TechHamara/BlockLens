...
class ExtensionSection extends View {
    ...
    renderDocumentation(container) {
        ...
        container.domElement.style.boxShadow = '0 1px 3px var(--shadow)';
        container.domElement.style.lineHeight = '1.6';
        // Use CSS variables instead of hardcoded colors for theme support
        container.domElement.style.setProperty('background-color', 'var(--bg-secondary)');
        container.domElement.style.setProperty('color', 'var(--text)');
    }
}
...
class BlockCard extends View {
    ...
    getSvg() {
        ...
        try {
            ...
            console.error('Mock rendering fallback failed', e);
        }
